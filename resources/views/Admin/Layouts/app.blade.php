                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-edit2"></span><span class="mtext">Bölümler</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-edit"></span><span class="mtext">Bronlamak Barada</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{ route('Reservation.index') }}">Bronlar</a></li>
                            <li><a href="{{ route('Product.index') }}">Haryt</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-edit"></span><span class="mtext">Bannerler</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li>
                        <a href="https://dropways.github.io/deskapp-free-single-page-website-template/"
                            ...
                            <span class="mtext">Landing Page <img
                                    src="{{ asset('vendors/images/coming-soon.png') }}" alt=""
                                    width="25"></span>
                        </a>
                    </li>
                </ul>
